export const Constantes = {
    ...
    cliente: './assets/img/landrover.png',
    clientesf: './assets/img/landroversf.png',
    ...
    urlCliente: 'https://www.landrover.co/'
}